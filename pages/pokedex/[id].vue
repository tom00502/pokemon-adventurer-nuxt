...
<template>
    <div id="capture" ref="mainBody" class="bg-white">
        ...
        <div class="mt-2 flex justify-center gap-2">
            <TypeIcon
                v-for="type in pokemon.attribute"
                :key="type"
                :type="typeTwToEn[type]"
        ...
        <fieldset class="border-t border-blue-200 p-2">
            ...
            <div class="flex flex-wrap items-center justify-center gap-2">
                <MoveIcon
                    v-for="move in pokemon.learnMoves"
                    :key="move"
                    :move-id="move"
                    class="grow"
                    @click="() => handleClickMove(move)"
        ...
        <fieldset class="border-t border-blue-200 p-2">
            ...
            <div class="flex flex-wrap items-center justify-center gap-2">
                <AbilityCard
                    v-for="ability in pokemon.features"
                    :key="ability"
                    :ability-id="ability"
                    class="grow"
        ...
        <fieldset class="border-t border-blue-200 p-2">
            ...
            <div v-if="rechargeCompetitions" class="ml-2 p-2">
                ...
                <details
                    v-for="(incomes, key) in rechargeCompetitions"
                    :key="key"
                    class="mt-1 pl-4"
                >
                    <summary>
            ...
            <div v-if="summerSales" class="ml-2 p-2">
                ...
                <details v-for="(incomes, key) in summerSales" :key="key" class="mt-1 pl-4">
                    <summary>
                        活動期間指定消費<span class="text-red-800">{{ key }}</span
                        >鎂獲得
                    </summary>
                    <div v-for="income in incomes" :key="income.start" class="ml-4">
                        {{ income.during }}
            ...
            <div v-if="limitedPurchasePackages" class="ml-2 p-2">
                ...
                <details
                    v-for="(incomes, key) in limitedPurchasePackages"
                    :key="key"
                    class="mt-1 pl-4"
                >
                    <summary>
        ...
        <fieldset v-if="gradeCardUse.gradeCards.length" class="border-t border-blue-200 p-2">
            ...
            <div class="flex flex-wrap items-center justify-center gap-2">
                <div
                    class="relative mt-2 max-w-[calc(100vw-48px)] overflow-x-auto shadow-md sm:rounded-lg"
                >
