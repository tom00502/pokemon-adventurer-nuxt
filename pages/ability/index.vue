...
const pokes = computed(() => {
    return pokedexStore.localePokemons.filter((poke) => poke.features.length)
})
onMounted(() => {
    setTimeout(() => {
...
<main>
    ...
    <div class="relative mt-1 overflow-x-auto">
        <table class="w-full text-left text-sm text-gray-500">
            ...
            <tbody>
                <tr v-for="(item, key) in filterAbilities" :key="key" class="border-b bg-white cursor-pointer"
