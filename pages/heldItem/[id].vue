    ...
    <fieldset class="border-t border-blue-200 p-2">
        ...
        <div class="relative mt-2 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-center text-sm text-gray-500">
                ...
                <tbody>
                    <tr v-for="level in 6" :key="level" class="border-b bg-white hover:bg-gray-50">
                        <th scope="row" class="whitespace-nowrap py-1 px-1 font-medium text-gray-900">
                            <div class="py-1 px-1">
                                {{ level }}
                            </div>
                        </th>
                        <td class="py-1 px-1">
                            <div v-if="star[level][heldItem.quality]">
                                {{
                                    `${star[level][heldItem.quality]}(${star[level][heldItem.quality] / exp[heldItem.quality]
                                    }碎片)`
                                }}
                            </div>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            {{
                                `${star['total'][heldItem.quality]}(${star['total'][heldItem.quality] / exp[heldItem.quality]
                                }碎片)`
                            }}
                        </td>
                        <td></td>
    ...
    <fieldset class="border-t border-blue-200 p-2">
        ...
        <div class="relative mt-2 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-center text-sm text-gray-500">
                ...
                <tbody>
                    <tr v-for="level in 30" :key="level" class="border-b bg-white hover:bg-gray-50">
                        <th scope="row" class="cursor-pointer whitespace-nowrap py-1 px-1 font-medium text-gray-900">
                            <div class="py-1 px-1">
                                {{ level }}
                            </div>
                        </th>
    ...
    <fieldset class="border-t border-blue-200 p-2">
        ...
        <div class="relative mt-2 overflow-x-auto shadow-md sm:rounded-lg">
            <table class="w-full text-center text-sm text-gray-500">
                ...
                <tbody>
                    <tr v-for="level in 29" :key="level" class="border-b bg-white hover:bg-gray-50">
                        <th scope="row" class="cursor-pointer whitespace-nowrap py-1 px-1 font-medium text-gray-900">
                            <div class="py-1 px-1">
                                {{ level }}
                            </div>
